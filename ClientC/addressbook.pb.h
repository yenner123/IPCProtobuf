...
#ifndef PROTOBUF_addressbook_5fcpp_2eproto__INCLUDED
#define PROTOBUF_addressbook_5fcpp_2eproto__INCLUDED
...
class Person_PhoneNumber : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.Person.PhoneNumber) */ {
 ...
 private:
  ...
  int type_;
  friend void  protobuf_AddDesc_addressbook_5fcpp_2eproto();
  friend void protobuf_AssignDesc_addressbook_5fcpp_2eproto();
  friend void protobuf_ShutdownFile_addressbook_5fcpp_2eproto();
...
#endif  // PROTOBUF_addressbook_5fcpp_2eproto__INCLUDED
